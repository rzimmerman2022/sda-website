...
*Production Edition with Regulatory Compliance*
  ...
  -----------------------------------------------------------------------
  **Document Number**    SDA-SOP-DEV-001
  ---------------------- ------------------------------------------------
  **Version**            5.2.1 (Gold Standard Compliance Edition)

  **Effective Date**     November 30, 2025

  **Classification**     **INTERNAL -- CONFIDENTIAL**

  **Department**         Engineering / Data Operations

  **Compliance**         AICPA QM \| EU AI Act \| PCAOB \| Agentic AI
...
**DOCUMENT APPROVAL SIGNATURES**
  ...
  ----------------- ----------------- ----------------- -----------------
       Author       Engineering Team                       2025-11-30
...
*This one-page summary provides executives, clients, and auditors with a
high-level overview of SparkData\'s AI-assisted development quality
controls.*

**STANDARDS ALIGNMENT**

  -----------------------------------------------------------------------
  **AICPA QM (SQMS  Risk-based quality management with multi-model
  No. 1)**          independent verification, monitoring, and remediation
                    processes
  ----------------- -----------------------------------------------------
  **EU AI Act**     Technical documentation, structured logging with JSON
                    schemas, human oversight hooks, and transparency
                    requirements

  **PCAOB           Adversarial review protocols, professional skepticism
  Guidance**        enforcement, complete audit trails, and decision
                    logging

  **Agentic AI      Multi-agent architecture
  Patterns**        (Planner/Builder/Reviewer/Auditor), tool verification
                    loops, guardrails, and feedback systems
  -----------------------------------------------------------------------

**AI QUALITY CONTROLS APPLIED**

+-----------------------------------+-----------------------------------+
| **LOW RISK (T0/T1)**              | **HIGH RISK (T2/T3)**             |
+===================================+===================================+
| • 1-2 AI agents                   | • Full multi-agent pipeline       |
|                                   |                                   |
| • Quick adversarial review        | • 4 specialized review lenses     |
|                                   |                                   |
| • Minimal evidence                | • Complete logging + decision     |
| (test/lint/types)                 | JSON                              |
|                                   |                                   |
| • Human merges PR                 | • Senior + Compliance sign-off    |
+-----------------------------------+-----------------------------------+

**HOW WE PREVENT \"LLM ECHO CHAMBER\" FAILURES**

> ✓ Fresh chat sessions for each review role (Reviewer never sees
> Builder\'s reasoning)
>
> ✓ Different model families required for T3 (Claude / GPT / Gemini)
>
> ✓ Devil\'s Advocate review triggered when agreement exceeds 80%
>
> ✓ Only actual tool outputs (tests, lints) are shared---never prose
> explanations

**AUDIT ARTIFACTS AVAILABLE**

  -----------------------------------------------------------------------
  **Decision Logs**         **Review Reports**       **Model Scorecards**
  ------------------------- ------------------------ --------------------
  DECISION\_\*.json with    VERIFICATION\_\*.md,     90-day rolling
  model attribution, risk   PERSPECTIVE\_\*.md,      metrics: defects,
  tier, metrics, human      COMPARISON\_\*.md        incidents, rollbacks
  override                                           per model

  -----------------------------------------------------------------------

**COMPANION DOCUMENTS:** Risk Tiering Matrix (v2.1) • IDE Quick Prompts
(v2.1) • Model Scorecard Template
...
# REVISION HISTORY
  ...
  ------------- ------------ ------------- ------------------------------------------------------
      5.2.0      2025-11-30   Engineering  Gold Standard Final - Fresh chat separation (§3.2.1),
                                           Inline AI policy (§3.2.2), T1 worked example, AI
                                           orchestrator script, Data-Quality Lens, agreement
                                           measurement clarification

      5.1.0      2025-11-15   Engineering  AICPA QM alignment, EU AI Act compliance, risk
                                           tiering, IDE prompts

      5.0.0      2025-10-01   Engineering  Multi-agent governance, adversarial review, proof of
                                           work

      4.0.0      2025-08-01   Engineering  Initial Gold Standard Edition with Five Pillars
  -----------------------------------------------------------------------------------------------

**PURPOSE:** Establish mandatory procedures for AI-assisted development
ensuring compliance with AICPA QM, EU AI Act, and PCAOB standards.

**SCOPE:** All engineering personnel, contractors, and AI systems
involved in software development, data pipelines, and code review.

**CROSS-REFERENCES:** See Risk Tiering & Required Controls (v2.1) for
canonical tier matrix (SOP §1.2). All IDE usage for T1-T3 must follow
SparkData_IDE_Quick_Prompts_v2.1.

# CRITICAL RULES & QUICK REFERENCE

+-----------------------------------------------------------------------+
| **⚠️ GOLDEN RULE: WHEN IN DOUBT, CHOOSE THE HIGHER TIER ⚠️**          |
|                                                                       |
| If you are unsure whether a change is T1 or T2, treat it as T2. If    |
| unsure between T2 and T3, treat it as T3. Erring on the side of       |
| caution protects code quality and ensures compliance.                 |
+=======================================================================+

**IDE SHORTCUTS BY RISK TIER**

  -------------------------------------------------------------------------------
   **Tier**  **Required IDE Prompts**
  ---------- --------------------------------------------------------------------
    **T0**   \"Build this\" only (review optional)

    **T1**   \"Build this\" → \[NEW CHAT\] → \"Review this\"

    **T2**   \"Build this\" → \[NEW CHAT\] → \"Verify T2/T3\" + at least 1 Lens
             (Security OR Performance)

    **T3**   All T2 + ALL 4 Lenses + \"Compare models\" + \"Challenge this\" (if
             \>80% agreement)
  -------------------------------------------------------------------------------
...
+-----------------------------------+----------------------------------+
| **❌ DO NOT PASTE**               | **✓ DO PASTE**                   |
+===================================+==================================+
| • Prior chat logs                 | • Original                       |
|                                   | requirement/spec/ticket          |
| • \"Here\'s what I did\" prose    |                                  |
| from Builder                      | • Actual diff or file contents   |
|                                   |                                  |
| • Screenshots of reasoning        | • Raw test output (pytest, jest, |
|                                   | etc.)                            |
| • Builder\'s explanations or      |                                  |
| summaries                         | • Lint/type checker output       |
|                                   | (actual text)                    |
+-----------------------------------+----------------------------------+

**AGREEMENT MEASUREMENT (\>80% TRIGGER)**

**How to measure:** Approximate issue-list similarity. Operationally:
\"If all reviewers raise essentially the same 2-3 issues and nothing
else, treat this as \>80% agreement and trigger Devil\'s Advocate
review.\"

**Why this matters:** High agreement may indicate echo-chamber behavior
where models reinforce each other rather than providing independent
analysis.

**PIPELINE/WORKFLOW TIER EXAMPLES**

  -------------------------------------------------------------------------------
   **Tier**  **Pipeline Example**             **Justification**
  ---------- -------------------------------- -----------------------------------
    **T0**   Adding logging to dev-only test  Non-prod, no data impact
             harness                          

    **T1**   Minor report formatting changes  UI only, no data model changes

    **T2**   New customer matching pipeline   Core business logic, affects data
                                              quality

    **T3**   Changes to MDRS scoring rules    Regulatory/compliance impact, PII
                                              adjacent
  -------------------------------------------------------------------------------
...
**Scenario:** Add deduplication logic to customer ingestion pipeline
  ...
  -----------------------------------------------------------------------------
   **1**  Chat A: Run Builder Mode (#1) → implement deduplication + tests
  ------- ---------------------------------------------------------------------
   **2**  Run: make evidence → collect test_evidence.txt, lint_evidence.txt,
          types_evidence.txt

   **3**  ⚠️ OPEN NEW CHAT B: Run Verification Mode (#3) → paste spec + diff +
          tool outputs only

   **4**  Chat B: Run Data-Quality Lens (#10) → pipeline-specific checks

   **5**  Chat B: Run Security-First Lens (#4) → verify no injection risks

   **6**  Create DECISION\_\*.json with all model attributions

   **7**  Get Lead approval → merge
  -----------------------------------------------------------------------------
...
**Scenario:** Modify authentication token validation logic
  ...
  -----------------------------------------------------------------------------
   **1**  Chat A (Claude): Run Builder Mode (#1) → implement token validation
          changes
  ------- ---------------------------------------------------------------------
   **2**  Run: make evidence → all evidence files

   **3**  ⚠️ NEW CHAT B (GPT-4): Run ALL 4 Lenses
          (Security/Perf/Maintain/Resilience)

   **4**  Check agreement: If \>80% overlap → Run Devil\'s Advocate (#8)

   **5**  ⚠️ NEW CHAT C (Gemini): Run Differential Comparison (#9) → compare
          outputs

   **6**  Save PERSPECTIVE\_\*.md (4 files) + COMPARISON\_\*.md

   **7**  Create DECISION\_\*.json listing all 3 model families used

   **8**  Get Senior Engineer + Compliance sign-off → merge
  -----------------------------------------------------------------------------

# IMPLEMENTATION CHECKLIST

*Use this checklist to operationalize the SOP. Check off each item as
implemented.*

**CI/CD ENFORCEMENT**

> ☐ Pre-commit hook to block merges without required evidence files for
> the declared tier
>
> ☐ CI job to verify DECISION\_\*.json exists for all AI-assisted PRs
>
> ☐ CI job to verify VERIFICATION\_\*.md exists for T2+ PRs
>
> ☐ CI job to verify 4x PERSPECTIVE\_\*.md files exist for T3 PRs
>
> ☐ CI job to validate tier in DECISION\_\*.json matches PR label

**IDE INTEGRATION**

> ☐ VS Code / Cursor snippet for each Quick Prompt shortcut (#1-#10)
>
> ☐ JetBrains live template for each Quick Prompt shortcut
>
> ☐ Documented macro for \"open new chat\" workflow enforcement
>
> ☐ Template files for DECISION\_\*.json, VERIFICATION\_\*.md,
> PERSPECTIVE\_\*.md

**MONITORING & REPORTING**

> ☐ Weekly script that generates model scorecard from DECISION\_\*.json
> logs
>
> ☐ Dashboard showing 90-day rolling defect/incident/rollback metrics
> per model
>
> ☐ Alert for models exceeding defect threshold → trigger role
> reassignment review
>
> ☐ Quarterly SOP compliance audit checklist

**TRAINING & ONBOARDING**

> ☐ New engineer onboarding includes SOP walkthrough + quiz
>
> ☐ Recorded video demonstrating T1, T2, T3 workflows end-to-end
>
> ☐ Cheat sheet posted in team wiki / Notion / Confluence
>
> ☐ Monthly \"SOP office hours\" for questions and edge cases

## Purpose

This SOP is designed so SparkData\'s AI-assisted development practices
align with emerging \"gold standard\" guidance on quality management and
AI governance, including:

### AICPA Quality Management Standards (SQMS No. 1)

Risk-based quality management with documented controls, monitoring, and
remediation for engagements that rely on technology. These standards
must be implemented by **Dec 15, 2025** for firms subject to them.

**Key Requirements:**

- Design, implement, and operate a system of quality management

- Risk-based approach to quality controls

- Monitoring and remediation processes

- Documentation of technology\'s role in engagements

**Our Alignment:**

- Independent Verification Agent (§1.1.1)

- Structured Decision Logging (§1.1.2)

- Automated Quality Feedback Loop (§1.1.5)

### EU AI Act (High-Risk Systems)

Risk-based obligations on AI providers and professional users, including
transparency, technical documentation, human oversight, and risk
management for \"high-risk\" AI systems and general-purpose AI.
...
- Structured Decision Logging with JSON schema (§1.1.2)

- Human Override fields in all decision records

- Multi-perspective review for high-risk changes (§1.1.3)

- Differential Model Comparison Gates (§1.1.4)

### PCAOB & Audit-Quality Guidance on AI Use

Emphasis on understanding how AI tools affect quality, documenting their
role, and implementing risk management controls around
technology-assisted analysis.

**Key Requirements:**

- Understand AI\'s impact on engagement quality

- Document AI\'s role in analysis

- Implement risk management controls

- Professional skepticism when using AI outputs

**Our Alignment:**

- Independent Verification Agent with adversarial review (§1.1.1)

- Perspective Diversity Protocol (§1.1.3)

- Devil\'s Advocate Review for suspicious agreement

- Complete audit trails

### Enterprise Agentic AI Patterns (Infosys, Grid Dynamics, VerifAI & Others)

Multi-agent, tool-using AI systems that follow a sense-plan-act loop,
with orchestration, guardrails, and assurance built in.

**Key Patterns:**

- Multi-agent architecture with specialized roles

- Tool-using agents with verification loops
...
- Planner/Builder/Reviewer/Orchestrator/Auditor roles (§3)

- OODA Loop for agentic pipeline construction (§17)
...
**This SOP is not legal advice.** Formal compliance with these
frameworks requires legal and compliance review. The goal is to ensure
that SparkData\'s engineering practices **naturally support**:

- [x] Independent verification (no single agent is trusted by default)

- [x] Complete, queryable audit trails for AI-assisted decisions

- [x] Multi-perspective reasoning and challenge

- [x] Continuous monitoring and improvement of AI impact on quality

## Standards Alignment Matrix

  -------------------------------------------------------------------------------
  **Requirement**     **AICPA     **EU AI     **PCAOB**   **Agentic   **SOP
                      QM**        Act**                   AI**        Section**
  ------------------- ----------- ----------- ----------- ----------- -----------
  Independent         ✓           ✓           ✓           ✓           §1.1.1, §9
  verification                                                        

  Audit trail /       ✓           ✓           ✓           ✓           §1.1.2, §13
  logging                                                             

  Multi-perspective   ✓           ✓           ✓           ✓           §1.1.3, §10
  review                                                              

  Model comparison                ✓                       ✓           §1.1.4, §15

  Quality monitoring  ✓           ✓           ✓           ✓           §1.1.5, §14
...
SparkData Analytics operates on five foundational principles. **All AI
assistants and workflows must adhere to these.**

### Pillar 1: Reproducibility

Every action must be repeatable with:

- Explicit commands (no \"it should work\")

- Versioned dependencies (lock files required)

- Deterministic builds (same input → same output)

- Environment fingerprints (tool versions captured)

### Pillar 2: Observability

You can\'t fix what you can\'t see:

- Every operation produces logs
...
- Pipeline re-runs don\'t duplicate data
...
- Links between sessions are explicit

- Evolution is tracked in CHANGELOG

- Tribal knowledge is captured in docs

### Pillar 5: Independent Verification & Multi-Perspective Reasoning ⚠️ NEW

**No single model\'s output is trusted on its own for material
changes.**

Critical work (pipelines, workflows, financial/mission-critical logic)
must pass through:

- An **independent verification agent**, and

- Where appropriate, multiple specialized review perspectives
  (security-first, performance-first, maintainability-first,
  resilience-first)

This directly supports:

- **AICPA QM:** Risk-based quality controls, monitoring, and remediation

- **EU AI Act:** Technical robustness, oversight, and documentation of
  AI-assisted decisions

- **PCAOB guidance:** Understanding and controlling how AI affects
  quality of work

# Section 1.1: Multi-Agent Governance & Quality Controls (SparkData)

SparkData\'s AI workflows are explicitly **multi-agent** and
**evidence-driven**. We use five key patterns:
...
For any non-trivial change (especially data pipelines, workflows, and
production services), a **Verification Agent** reviews the work
**independently** of the Implementing Agent.

### How It Works

- All candidate solutions (from one or more models) are generated from
  the **same original requirement** (ticket, spec, ADR), not from each
  other\'s explanations.

- The Verification Agent sees:
...
- The Verification Agent does **NOT** see:
...
> **1. Reconstruct** the intended behavior from the requirement (3-5
> bullets)
>
...
\- NON-BLOCKING -- can merge but follow-ups created

\- APPROVE WITH RISKS -- risks documented
...
|                                                                       |
| From the REQUIREMENT alone, write 3-5 bullet points describing what   |
| this change should accomplish.                                        |
|                                                                       |
...
### Diff Analysis
  ...
  -----------------------------------------------------------------------
  **Hunk**                **Assessment**          **Issues**
  ----------------------- ----------------------- -----------------------
  \[location\]            \[OK/CONCERN\]          \[description\]
...
### Issues
  ...
  **\#**         **Severity**   **Category**   **Description**   **Location**
  -------------- -------------- -------------- ----------------- ---------------
  1              \[H/M/L\]      \[category\]   \[description\]   \[file:line\]

  ------------------------------------------------------------------------------

### Certification

This verification was conducted independently without access to the
implementer\'s reasoning.

### Alignment

- **AICPA QM / PCAOB:** Independent checks and risk-based quality
  controls

- **EU AI Act:** Human-in-the-loop oversight plus technical
...
Every material AI-assisted decision is captured as a structured JSON
record for auditability.

### Storage

- **Directory:** logs/ai-decisions/YYYY/MM/DD/

- **File naming:**
  DECISION\_\[TIMESTAMP\]\_\[PROJECT\]\_\[ARTIFACT\].json
...
|                                                                        |
| \"category\":                                                          |
| \"correctness\|data_quality\|security\|performance\|maintainability\", |
|                                                                        |
...
- **EU AI Act:** Technical documentation and traceability obligations

- **AICPA/PCAOB:** Monitoring quality and the impact of technology on
  engagement quality

- **Internal analytics:** Feed into Automated Quality Feedback Loop
  (§1.1.5)
...
|                                                                       |
| jq \'select(.decision.issues_found\[\] \| .severity ==                |
| \"critical\")\' logs/ai-decisions/\*\*/\*.json                        |
|                                                                       |
| \# Find all decisions requiring human override                        |
|                                                                       |
| jq \'select(.human_override.status != \"none\")\'                     |
| logs/ai-decisions/\*\*/\*.json                                        |
|                                                                       |
| \# Find decisions by model                                            |
|                                                                       |
| jq \'select(.models_involved\[\] \| .name == \"claude-opus-4\")\'     |
| logs/ai-decisions/\*\*/\*.json                                        |
|                                                                       |
| \# Find high-risk changes                                             |
|                                                                       |
| jq \'select(.input_context.risk_level == \"high\" or                  |
| .input_context.risk_level == \"critical\")\'                          |
| logs/ai-decisions/\*\*/\*.json                                        |
+=======================================================================+
...
For high-risk changes (core data models, security-sensitive code,
critical pipelines), we run multiple **specialized review agents**, each
...
- **Resilience-First Reviewer** (failure modes, backfills, retries,
  disaster scenarios)
...
>
> **2.** Each reviewer is instructed to **optimize for its own dimension
> only**, and to assume other concerns will be handled by other
> reviewers
>
> **3.** We measure similarity between their issue lists
>
> **4.** If outputs are nearly identical (cosine similarity \> 0.9 on
> issue descriptions), we treat it as a **RED FLAG** that perspectives
> are not diverse enough
>
> **5.** If similarity is too high, trigger a **Devil\'s Advocate
> Reviewer**
...
+-----------------------------------------------------------------------+
| You are the SECURITY-FIRST Reviewer. Your ONLY job is to find         |
| security issues.                                                      |
|                                                                       |
| Assume performance, maintainability, and resilience are someone       |
| else\'s problem.                                                      |
|                                                                       |
| Focus areas:                                                          |
|                                                                       |
...
+-----------------------------------------------------------------------+
| You are the PERFORMANCE-FIRST Reviewer. Your ONLY job is to find      |
| performance issues.                                                   |
|                                                                       |
| Assume security, maintainability, and resilience are someone else\'s  |
| problem.                                                              |
|                                                                       |
| Focus areas:                                                          |
|                                                                       |
...
+-----------------------------------------------------------------------+
| You are the MAINTAINABILITY-FIRST Reviewer. Your ONLY job is to find  |
| maintainability issues.                                               |
|                                                                       |
| Assume security, performance, and resilience are someone else\'s      |
| problem.                                                              |
|                                                                       |
| Focus areas:                                                          |
|                                                                       |
...
+-----------------------------------------------------------------------+
| You are the RESILIENCE-FIRST Reviewer. Your ONLY job is to find       |
| resilience issues.                                                    |
|                                                                       |
| Assume security, performance, and maintainability are someone else\'s |
| problem.                                                              |
|                                                                       |
| Focus areas:                                                          |
|                                                                       |
...
|                                                                       |
| Your job is to find risks that others might have missed, even if      |
...
- Mirrors multi-perspective review practices in audit and
  safety-critical engineering

- Supports EU AI Act\'s emphasis on risk management and robustness by
  forcing the system to look for different categories of failure

- Implements PCAOB\'s professional skepticism requirement

## 1.1.4 Differential Model Comparison Gates (Quick Win #4)

### Definition

For certain classes of work, we deliberately use **multiple models**
(e.g., Claude Opus + GPT-5) and compare their outputs before committing.

### When to Use

- New pattern / technology (e.g., first time using a new data store)
...
- Anything rated \"high\" or \"critical\" risk
...
| ┌─────────────────────────────────────────────────────────────────────────────┐ |
|                                                                                 |
| │ DIFFERENTIAL MODEL COMPARISON GATE │                                          |
|                                                                                 |
| ├─────────────────────────────────────────────────────────────────────────────┤ |
|                                                                                 |
| │ │                                                                             |
...
|                                                                                 |
| │ ├─ Model A (Claude) implements from spec │                                    |
|                                                                                 |
| │ ├─ Model B (GPT-5) implements from spec │                                     |
|                                                                                 |
| │ └─ Neither sees the other\'s work │                                           |
|                                                                                 |
| │ │                                                                             |
|                                                                                 |
| │ Step 2: DIFF & DIVERGENCE ANALYSIS │                                          |
|                                                                                 |
| │ ├─ Comparison Agent highlights where implementations differ │                 |
|                                                                                 |
| │ └─ Classifies differences: correctness, data quality, security, │             |
|                                                                                 |
| │ performance, style │                                                          |
|                                                                                 |
| │ │                                                                             |
...
| │ For each difference: │                                                        |
|                                                                                 |
| │ ├─ Which model is more conservative on validation? │                          |
|                                                                                 |
| │ ├─ Which introduces more complexity? │                                        |
|                                                                                 |
| │ ├─ Which tests are stronger? │                                                |
|                                                                                 |
...
| │ Choose: │                                                                     |
|                                                                                 |
| │ ├─ \"Model A\" (use A\'s implementation) │                                    |
|                                                                                 |
| │ ├─ \"Model B\" (use B\'s implementation) │                                    |
|                                                                                 |
| │ └─ \"Hybrid\" (explicitly combining best parts) │                             |
|                                                                                 |
| │ │                                                                             |
|                                                                                 |
| │ Decision and reasoning → Structured Decision Log │                            |
|                                                                                 |
| │ │                                                                             |
|                                                                                 |
| └─────────────────────────────────────────────────────────────────────────────┘ |
...
- Similar to ensemble and multi-agent patterns seen in production
  agentic AI design

- Reduces the risk of a single-model blind spot driving a critical
  defect

- Supports EU AI Act requirements for robust AI systems

## 1.1.5 Automated Quality Feedback Loop (Quick Win #5)

### Objective

Track real-world outcomes of AI-assisted changes and feed that data back
into:
...
- Review intensity (how many reviewers, which perspectives)
...
For each merged change, we log (manually or via automation):
  ...
  **Field**                **Description**         **Source**
  ------------------------ ----------------------- -----------------------
  origin_model             Which model(s) authored Decision Log
                           and verified            

  risk_level               Low / medium / high /   Decision Log
                           critical                

  post_deploy_incidents    Number and severity of  Incident tracker
                           incidents               

  bug_reports              Count within 30/60/90   Bug tracker
                           days                    

  rollbacks                Whether the change was  Deploy system
                           rolled back             

  SLO_impact               Any SLO/SLA breaches    Monitoring
                           linked to this change   

  data_quality_incidents   For pipelines: failed   dbt/Great Expectations
                           expectations, schema    
                           regressions             
  ------------------------------------------------------------------------
...
| ║ ┌─────────────────────────────────────────────────────────────────────────┐ ║   |
|                                                                                   |
| ║ │ ROLE │ CHANGES │ DEFECTS │ INCIDENTS │ ROLLBACKS │ SCORE │ ║                  |
|                                                                                   |
| ║ │───────────────│─────────│─────────│───────────│───────────│────────────│ ║    |
|                                                                                   |
| ║ │ Builder │ 78 │ 2 │ 0 │ 1 │ 94/100 │ ║                                         |
|                                                                                   |
| ║ │ Verifier │ 120 │ FN: 3 │ - │ - │ 92/100 │ ║                                   |
|                                                                                   |
| ║ │ Security Rev │ 45 │ FN: 1 │ - │ - │ 96/100 │ ║                                |
|                                                                                   |
| ║ │ Perf Review │ 38 │ FN: 2 │ - │ - │ 91/100 │ ║                                 |
|                                                                                   |
| ║ └─────────────────────────────────────────────────────────────────────────┘ ║   |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ Best For: Security reviews, complex data pipelines ║                            |
|                                                                                   |
| ║ Caution: Performance edge cases ║                                               |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ Trend: STABLE (no significant change from Q3) ║                                 |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ╚═══════════════════════════════════════════════════════════════════════════════╝ |
...
### Scorecard Metrics
  ...
  **Metric**        **Formula**       **Target**        **Warning**
  ----------------- ----------------- ----------------- -----------------
  Defect Rate       defects / changes \< 2%             \> 5%

  Incident Rate     incidents /       \< 1%             \> 3%
                    changes                             

  Rollback Rate     rollbacks /       \< 1%             \> 2%
                    changes                             

  False Negative    missed issues /   \< 10%            \> 20%
  Rate              total issues                        

  Mean Time to      avg days to fix   \< 2 days         \> 5 days
  Remediate         related incidents                   
  -----------------------------------------------------------------------
...
- The model + pattern with the best track record for that domain

If a model shows sustained poor performance:

- Reduce its role to low-risk or sandbox work

- Adjust prompts or deprecate its use
...
| \# Review trends                                                      |
|                                                                       |
| ./scripts/compare-scorecards.sh \--current 2025-11 \--previous        |
| 2025-10                                                               |
|                                                                       |
| \# Update preferences                                                 |
|                                                                       |
...
- Directly addresses regulator concerns that firms must understand and
  monitor how AI affects quality, not just \"use AI and hope\"

- Fits AICPA QM / PCAOB expectations for monitoring and remediation

- Supports EU AI Act\'s emphasis on ongoing risk management for AI
  systems
...
When starting a session that will involve AI-assisted code or pipeline
changes, identify:
...
|                                                                       |
| \- \[ \] Independent Verification Agent required? (HIGH/CRITICAL:     |
| YES)                                                                  |
|                                                                       |
...
**Use for:** All material AI-assisted changes (code, pipelines,
configurations)
...
| Phase 1: IMPLEMENT                                                    |
|                                                                       |
| ├─ Builder Agent creates implementation from spec                     |
|                                                                       |
| ├─ Tests written (TDD preferred)                                      |
|                                                                       |
| ├─ All tool checks run (test, lint, types)                            |
|                                                                       |
| └─ Output: Code + PROGRESS report                                     |
|                                                                       |
| Phase 2: INDEPENDENT VERIFICATION (§1.1.1)                            |
|                                                                       |
| ├─ Fresh session (no prior context)                                   |
|                                                                       |
| ├─ Verification Agent reviews: spec + diff + tool output              |
|                                                                       |
| ├─ Does NOT see Builder\'s reasoning                                  |
|                                                                       |
| ├─ Issues decision: BLOCKING / NON-BLOCKING / APPROVE WITH RISKS      |
|                                                                       |
| └─ Output: VERIFICATION report                                        |
|                                                                       |
| Phase 3: PERSPECTIVE DIVERSITY (if HIGH/CRITICAL risk) (§1.1.3)       |
|                                                                       |
| ├─ 4 specialized reviewers run in parallel                            |
|                                                                       |
| ├─ Each sees same inputs                                              |
|                                                                       |
| ├─ Similarity check on outputs                                        |
|                                                                       |
| ├─ Devil\'s Advocate if similarity \> 0.9                             |
|                                                                       |
| └─ Output: 4x PERSPECTIVE reports + DIVERGENCE analysis               |
|                                                                       |
| Phase 4: DIFFERENTIAL GATE (if CRITICAL risk) (§1.1.4)                |
|                                                                       |
| ├─ Second model implements same spec                                  |
|                                                                       |
| ├─ Comparison Agent analyzes differences                              |
|                                                                       |
| ├─ Risk matrix generated                                              |
|                                                                       |
| ├─ Choose: Model A / Model B / Hybrid                                 |
|                                                                       |
| └─ Output: COMPARISON report                                          |
|                                                                       |
| Phase 5: DECISION LOGGING (§1.1.2)                                    |
|                                                                       |
| ├─ Create structured JSON decision record                             |
|                                                                       |
| ├─ All models and sessions documented                                 |
|                                                                       |
| ├─ Issues and decisions recorded                                      |
|                                                                       |
| ├─ Human override field populated (if applicable)                     |
|                                                                       |
| └─ Output: DECISION\_\*.json                                          |
|                                                                       |
| Phase 6: MERGE OR REWORK                                              |
|                                                                       |
| ├─ If BLOCKING issues: Return to Phase 1                              |
|                                                                       |
| ├─ If NON-BLOCKING: Create follow-up tickets, proceed                 |
|                                                                       |
| ├─ If APPROVED: Merge with confidence                                 |
|                                                                       |
| └─ Link Decision Log to PR/commit                                     |
|                                                                       |
| Phase 7: OUTCOME TRACKING (§1.1.5)                                    |
|                                                                       |
| ├─ Link Decision Log to deployment                                    |
|                                                                       |
| ├─ Monitor for 90 days                                                |
|                                                                       |
| ├─ Record incidents, defects, rollbacks                               |
|                                                                       |
| └─ Feed into Model Scorecard                                          |
|                                                                       |
| ════════════════════════════════════════════════════════════════════  |
+=======================================================================+
...
## Role Definitions (with Governance Alignment)
  ...
  -----------------------------------------------------------------------
  **Role**                **Governance Function** **Standards Alignment**
  ----------------------- ----------------------- -----------------------
  **Planner Agent**       Defines what to build   AICPA: Design controls

  **Builder Agent**       Creates implementation  \-

  **Verification Agent**  Independent review      AICPA/PCAOB: Quality
                                                  controls

  **Perspective           Multi-lens analysis     EU AI Act: Robustness
  Reviewers**                                     

  **Comparison Agent**    Cross-model analysis    Agentic AI: Ensemble
                                                  patterns

  **Orchestrator Agent**  Tool execution          \-

  **Auditor Agent**       Compliance check        EU AI Act: Human
                                                  oversight
  -----------------------------------------------------------------------
...
> **1. All decisions must be captured** in the structured decision log
> (§1.1.2)
>
> **2. High-risk changes** must involve the Verification Agent (§1.1.1)
>
> **3. Critical changes** must involve multi-perspective reviews
> (§1.1.3)
>
> **4. Test coverage** is verified by tool output, not model claims
>
> **5. Outcome tracking** feeds into Model Scorecard (§1.1.5)
...
Add to your monitoring dashboard:
  ...
  **Metric**                     **Description**         **Alert Threshold**
  ------------------------------ ----------------------- -----------------------
  ai_decisions_total             Count of AI-assisted    \-
                                 decisions               

  ai_decisions_blocked           Decisions with BLOCKING \> 20%
                                 issues                  

  ai_model_defect_rate           Defects per model per   \> 5%
                                 100 changes             

  ai_verification_disagreement   Verifier disagreed with Track
                                 Builder                 

  ai_perspective_similarity      Similarity between      \> 0.9 (alert)
                                 perspective reviewers   

  ai_human_overrides             Human overrides of AI   Track
                                 decisions               
  ------------------------------------------------------------------------------

This ensures AI-assisted development is itself monitored like any other
system.
...
### ⚡ Bookmark These Five Prompts

  ----------------------------------------------------------------------------------
  **Use Case**            **Section**                        **When to Use**
  ----------------------- ---------------------------------- -----------------------
  🟢 **Session Start**    \[§5.1\](#session-init-standard)   Beginning ANY work
                                                             session

  🔴 **Adversarial        \[§8.1\](#acr-prompt)              Before committing ANY
  Review**                                                   code

  🤖 **Agentic Pipeline** \[§13.1\](#ooda-loop)              Building complex data
                                                             workflows

  📝 **Progress Report**  \[§6.1\](#workflow-1)              End of work sessions

  🤝 **Complete Handoff** \[§6.2\](#workflow-2)              When another person/AI
                                                             takes over
  ----------------------------------------------------------------------------------

### 🚨 Critical Rule: Never Skip the Adversarial Review

**Before ANY code is committed or marked complete:**

> **1.** Open a **fresh chat session** (no prior context)
>
> **2.** Run the **Adversarial Code Review** prompt (§8.1)
>
> **3.** Require **Proof of Work** artifacts (§11)
>
> **4.** Document findings in **REVIEW\_\[timestamp\].md**
...
### Pillar 5: Adversarial Independence ⚠️ NEW

**No single model\'s output is trusted by default.**

Every meaningful code or pipeline change is:

- Backed by **executable tests and invariants**

- Reviewed by an **independent AI auditor** that:
...
> *\*\*The Echo Chamber Problem:\*\* LLMs are trained to be helpful. If
> an AI reads another AI\'s reasoning, it will tend to agree to remain
> \"consistent.\" This is why Reviewer Agents must operate blind to
> Builder explanations.*

## 3. AI Coding Roles & Modes {#ai-roles}

SparkData uses **role separation** to prevent sycophancy and ensure
quality. Each role has distinct permissions and constraints.

### 3.1 Role Definitions

  --------------------------------------------------------------------------
  **Role**          **Responsibility**   **Has Access To** **Does NOT Have
                                                           Access To**
  ----------------- -------------------- ----------------- -----------------
  **Planner Agent** Convert requirements Requirements,     Implementation
                    → technical plan     existing          details
                                         architecture,     
                                         ADRs              

  **Builder Agent** Write/modify code    Spec, codebase,   Review authority
                    per spec             test framework    

  **Reviewer        Find problems,       Spec, diffs, test Builder\'s
  Agent**           approve/reject       output, standards explanations

  **Orchestrator    Run tools,           CLI, test         Decision
  Agent**           coordinate loop      runners, linters  authority

  **Auditor Agent** Compliance,          All artifacts,    Modification
                    security, governance policies          authority
  --------------------------------------------------------------------------
...
| │ NEVER DO THIS │                                                       |
|                                                                         |
| │ Builder Agent reviews its own code in the same session │              |
|                                                                         |
| │ Reviewer Agent sees Builder\'s explanation before reviewing │         |
|                                                                         |
| │ Single chat thread handles both implementation AND review │           |
|                                                                         |
| └─────────────────────────────────────────────────────────────────────┘ |
|                                                                         |
| ┌─────────────────────────────────────────────────────────────────────┐ |
...
| │ ALWAYS DO THIS │                                                      |
|                                                                         |
| │ Builder Agent completes work → artifacts saved │                      |
|                                                                         |
| │ Fresh session opened for Reviewer Agent │                             |
|                                                                         |
| │ Reviewer only sees: spec + code + test results │                      |
|                                                                         |
| │ Different models for Builder vs Reviewer when possible │              |
|                                                                         |
| └─────────────────────────────────────────────────────────────────────┘ |
+=========================================================================+

### 3.2.1 🔴 HARD RULE: FRESH CHAT SEPARATION

**⛔ If a chat has ever used Builder Mode in it, you may NOT use
Reviewer, Verification, or any Lens prompts in the same chat. Start a
new chat.**

This is non-negotiable. Mixing roles in the same chat defeats the entire
purpose of independent verification and creates the \"echo chamber\"
problem this SOP is designed to prevent.

**Recommended Convention:** Name your chat windows with role prefixes:

- \[B\] Feature X implementation

- \[R\] Feature X review

- \[V\] Feature X verification
...
>
> **2.** The appropriate **Reviewer / Verification / Lens prompts**
> before merge
...
| \*\*Model:\*\* \[MODEL_NAME\]                                         |
|                                                                       |
| \*\*Mode:\*\* \[PLANNER \| BUILDER \| REVIEWER \| ORCHESTRATOR \|     |
| AUDITOR\]                                                             |
|                                                                       |
| \*\*Timestamp:\*\* \[ISO-8601\]                                       |
|                                                                       |
...
|                                                                       |
| \- You MUST output: REVIEW\_\[timestamp\].md with                     |
| APPROVE/REJECT/BLOCK verdict                                          |
+=======================================================================+
...
|                                                                       |
| \- You MUST output: AUDIT\_\[timestamp\].md with findings             |
+=======================================================================+
...
| │                                                                     |
|                                                                       |
| ├─► Are you BEGINNING a session?                                      |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ ├─► YES: Is this a REVIEW session?                                  |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ ├─► YES → Use \"Blind Review Session Init\" (§5.3)                |
|                                                                       |
| │ │ │ Do NOT load previous explanations                               |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ └─► NO → Use \"Standard Session Init\" (§5.1)                     |
|                                                                       |
| │ │ Load full context                                                 |
|                                                                       |
| │ │                                                                   |
...
| │                                                                     |
|                                                                       |
| ├─► Are you ENDING a session?                                         |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ ├─► Need handoff to another person/AI?                              |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ ├─► YES → Use \"Workflow 2: Progress + Handoff + State\" (§6.2)   |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ └─► NO → Use \"Workflow 1: Progress Report\" (§6.1)               |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ └─► Continue below                                                  |
...
|                                                                       |
| │ │ │ └─► Use \"Workflow 4: Agentic Coding Loop\" (§6.4)              |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ └─► Simple (single file)?                                         |
|                                                                       |
| │ │ └─► Use \"Feature Implementation\" (§12.1)                        |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ ├─► CODE REVIEW / QC                                                |
...
| │ │ │                                                                 |
|                                                                       |
| │ │ ├─► Own code (same session)?                                      |
|                                                                       |
| │ │ │ └─► ⛔ STOP. Open NEW session for review.                       |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ └─► Other\'s code / fresh session?                                |
|                                                                       |
| │ │ └─► Use \"Adversarial Code Review\" (§8.1)                        |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ ├─► BUG FIX                                                         |
...
| │ │ ├─► Production incident?                                          |
|                                                                       |
| │ │ │ └─► Use \"Production Incident Response\" (§16.1)                |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ └─► Normal bug?                                                   |
|                                                                       |
| │ │ └─► Use \"TDD Bug Fix Loop\" (§8.5)                               |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ ├─► ARCHITECTURE DECISION                                           |
|                                                                       |
| │ │ └─► Use \"Architecture Decision Record\" (§14.1)                  |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ ├─► DEBUGGING                                                       |
...
|                                                                       |
| │ │ │ └─► Use \"Code Archaeology\" (§19.1)                            |
|                                                                       |
| │ │ │                                                                 |
|                                                                       |
| │ │ └─► Normal debugging?                                             |
|                                                                       |
| │ │ └─► Use \"Rubber Duck Debugging\" (§18.1)                         |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ └─► DATA PIPELINE                                                   |
...
| │ ├─► New pipeline?                                                   |
|                                                                       |
| │ │ └─► Use \"Agentic Pipeline Construction\" (§13.1)                 |
|                                                                       |
| │ │                                                                   |
|                                                                       |
| │ └─► Modify existing?                                                |
|                                                                       |
| │ └─► Use \"Pipeline Modification Checklist\" (§24.2)                 |
|                                                                       |
| │                                                                     |
|                                                                       |
| └─► NONE OF THE ABOVE                                                 |
|                                                                       |
| └─► Browse Part IV-VII for specific needs                             |
+=======================================================================+
...
All artifacts follow consistent naming for traceability:
  ...
  **Artifact Type**       **Pattern**                                                               **Example**
  ----------------------- ------------------------------------------------------------------------- ------------------------------------------------------------------
  Progress Reports        PROGRESS_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION_ID\].md                PROGRESS_2025-11-30_14-30-00_claude-opus_abc123.md

  Handoff Documents       docs/handoffs/HANDOFF_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION_ID\].md   docs/handoffs/HANDOFF_2025-11-30_14-30-00_gpt5_xyz789.md

  Review Documents        REVIEW_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION_ID\].md                  REVIEW_2025-11-30_15-00-00_claude-sonnet_def456.md

  Discrepancy Reports     DISCREPANCY_YYYY-MM-DD_HH-MM-SS.md                                        DISCREPANCY_2025-11-30_15-30-00.md

  Decision Records        docs/decisions/ADR_YYYY-MM-DD\_\[NUMBER\]\_\[TITLE_SLUG\].md              docs/decisions/ADR_2025-11-30_001_async-pipeline-architecture.md

  Session States          state/session_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION_ID\].json         state/session_2025-11-30_14-30-00_claude-opus_abc123.json

  Audit Reports           AUDIT_YYYY-MM-DD_HH-MM-SS\_\[MODEL\].md                                   AUDIT_2025-11-30_16-00-00_claude-opus.md

  Test Evidence           evidence/test_YYYY-MM-DD_HH-MM-SS.txt                                     evidence/test_2025-11-30_14-45-00.txt

  Lint Evidence           evidence/lint_YYYY-MM-DD_HH-MM-SS.txt                                     evidence/lint_2025-11-30_14-46-00.txt
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
**Use this when:** Starting a new work session in Builder or Planner
mode.

+-----------------------------------------------------------------------+
| \## Session Initialization - Builder/Planner Mode                     |
|                                                                       |
| Initialize yourself with the complete project context by reading and  |
| analyzing these files in order:                                       |
|                                                                       |
...
|                                                                       |
| \- Find: \`docs/handoffs/HANDOFF\_\*\_\[YOUR_MODEL\]\_\*.md\`         |
|                                                                       |
...
|                                                                       |
| \- \`PROGRESS\_\*.md\` (sorted by timestamp, most recent)             |
|                                                                       |
| \#### Session State                                                   |
|                                                                       |
| If available, load the most recent session state:                     |
|                                                                       |
| \- \`state/session\_\*.json\` (most recent)                           |
|                                                                       |
...
make build \|\| npm run build \|\| cargo build 2\>&1 \| tee
build_check.txt
...
|                                                                       |
| \- docs/decisions/ADR\_\*.md (most recent 3-5)                        |
|                                                                       |
...
| \-\--                                                                 |
|                                                                       |
| Only proceed with actual work after completing this initialization    |
| and receiving confirmation.                                           |
+=======================================================================+

### 5.2 Quick Session Initialization (Simple Continuations)

**Use this when:** Resuming simple work in the same day, no handoff
occurred.

+-----------------------------------------------------------------------+
| \## Quick Context Refresh                                             |
|                                                                       |
| 1\. Read most recent: \`PROGRESS\_\*.md\`                             |
|                                                                       |
| 2\. Check status: \`git status -sb\`                                  |
|                                                                       |
| 3\. Review your last handoff:                                         |
| \`docs/handoffs/HANDOFF\_\*\_\[YOUR_MODEL\]\_\*.md\`                  |
|                                                                       |
| 4\. Load session state if available: \`state/session\_\*.json\`       |
|                                                                       |
...
**Use this when:** Starting a REVIEW session. Critical: Do NOT load
previous explanations.

+-----------------------------------------------------------------------+
| \## Session Initialization - REVIEWER MODE (Blind)                    |
|                                                                       |
| ⚠️ CRITICAL: You are an INDEPENDENT REVIEWER.                         |
|                                                                       |
...
|                                                                       |
| \- docs/architecture/overview.md (structure only, not implementation  |
| notes)                                                                |
|                                                                       |
...
|                                                                       |
| Proceed with review using §8.1 Adversarial Code Review Protocol.      |
+=======================================================================+
...
Add this to ANY session initialization when you need to verify prior
work:
...
| \|\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\--\| |
|                                                                                                              |
| \| \"Feature X is complete\" \| Check test coverage for X \| \[RUN TESTS\] \| ❓ \|                          |
|                                                                                                              |
| \| \"All tests pass\" \| Run \`make test\` \| \[RUN TESTS\] \| ❓ \|                                         |
|                                                                                                              |
| \| \"Architecture is stable\" \| Check git log for churn \| \[RUN GIT LOG\] \| ❓ \|                         |
|                                                                                                              |
| \| \"No lint errors\" \| Run \`make lint\` \| \[RUN LINT\] \| ❓ \|                                          |
|                                                                                                              |
| \### Discrepancy Report                                                                                      |
|                                                                                                              |
...
| \"╔════════════════════════════════════════════════════════════╗\"    |
|                                                                       |
| echo \"║ SparkData Analytics - Context Gathering ║\"                  |
|                                                                       |
| echo                                                                  |
| \"╚════════════════════════════════════════════════════════════╝\"    |
|                                                                       |
...
|                                                                       |
| ls -la PROGRESS\_\*.md 2\>/dev/null \| tail -5 \|\| echo \" None      |
| found\"                                                               |
|                                                                       |
| echo -e \"\\n📋 Recent Handoffs:\"                                    |
|                                                                       |
| ls -la docs/handoffs/HANDOFF\_\*.md 2\>/dev/null \| tail -5 \|\| echo |
| \" None found\"                                                       |
|                                                                       |
| echo -e \"\\n🔴 Recent Reviews:\"                                     |
|                                                                       |
| ls -la REVIEW\_\*.md 2\>/dev/null \| tail -5 \|\| echo \" None        |
| found\"                                                               |
|                                                                       |
...
| echo -e \"\\n✅ Test Status:\"                                        |
|                                                                       |
| make test 2\>&1 \| tail -20 \|\| npm test 2\>&1 \| tail -20 \|\| echo |
| \"No test command found\"                                             |
|                                                                       |
| echo -e \"\\n🔍 Lint Status:\"                                        |
|                                                                       |
| make lint 2\>&1 \| tail -20 \|\| npm run lint 2\>&1 \| tail -20 \|\|  |
...
| found\"                                                               |
|                                                                       |
| echo -e \"\\n💾 Session States Available:\"                           |
|                                                                       |
| ls -la state/session\_\*.json 2\>/dev/null \| tail -3 \|\| echo \"    |
| None found\"                                                          |
|                                                                       |
| echo -e \"\\n🏗️ Build Status:\"                                       |
|                                                                       |
| make build 2\>&1 \| tail -10 \|\| npm run build 2\>&1 \| tail -10     |
...
|                                                                          |
| \*\*Filename:\*\*                                                        |
| \`PROGRESS\_\[YYYY-MM-DD\]\_\[HH-MM-SS\]\_\[MODEL\]\_\[SESSION_ID\].md\` |
|                                                                          |
| \### Required Sections:                                                  |
|                                                                          |
| \#### 1. Session Metadata                                                |
...
| \|\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\--\|\-\-\-\-\-\--\|                                                                  |
|                                                                                                                            |
| \| \[What you set out to do\] \| ✅/🔄/❌ \| \[What actually happened\] \|                                                 |
|                                                                                                                            |
...
+--------------------------------------------------------------------------------------+
| Attach: \`evidence/test\_\[timestamp\].txt\`                                         |
|                                                                                      |
| \#### 6. Knowledge Gained                                                            |
|                                                                                      |
...
|                                                                                      |
| \#### 7. Verification Status ⚠️ REQUIRED                                             |
|                                                                                      |
| \| Check \| Command \| Result \| Evidence File \|                                    |
|                                                                                      |
| \|\-\-\-\-\-\--\|\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\--\| |
|                                                                                      |
| \| Tests \| \`make test\` \| PASS/FAIL \| \`evidence/test\_\*.txt\` \|               |
|                                                                                      |
| \| Lint \| \`make lint\` \| PASS/FAIL \| \`evidence/lint\_\*.txt\` \|                |
|                                                                                      |
| \| Types \| \`make typecheck\` \| PASS/FAIL \| \`evidence/types\_\*.txt\` \|         |
|                                                                                      |
| \| Build \| \`make build\` \| PASS/FAIL \| \`evidence/build\_\*.txt\` \|             |
|                                                                                      |
...
**Trigger:** When another person or AI needs to take over with full
context.
...
**Filename:**
state/session\_\[TIMESTAMP\]\_\[MODEL\]\_\[SESSION_ID\].json
...
| \"attempted_solutions\": \[                                           |
|                                                                       |
| {\"approach\": \"Description\", \"outcome\": \"Result\",              |
...
|                                                                       |
| \"technical_debt_added\": \[\"Shortcuts taken that need               |
| addressing\"\]                                                        |
|                                                                       |
| },                                                                    |
|                                                                       |
...
**Filename:**
docs/handoffs/HANDOFF\_\[TIMESTAMP\]\_\[MODEL\]\_\[SESSION_ID\].md
...
|                                                                                             |
| \*\*Handoff From:\*\* \[MODEL/PERSON\] → \*\*To:\*\* \[MODEL/PERSON\]                       |
|                                                                                             |
| \*\*Session ID:\*\* \[UNIQUE_ID\]                                                           |
|                                                                                             |
| \## Quick Orientation                                                                       |
...
| \|\-\-\-\-\-\--\|\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\--\|                                     |
|                                                                                             |
| \| Build \| ✅/❌ \| \`evidence/build\_\*.txt\` \|                                          |
|                                                                                             |
| \| Tests \| ✅/❌ \| \`evidence/test\_\*.txt\` \|                                           |
|                                                                                             |
| \| Lint \| ✅/❌ \| \`evidence/lint\_\*.txt\` \|                                            |
|                                                                                             |
| \| Types \| ✅/❌ \| \`evidence/types\_\*.txt\` \|                                          |
|                                                                                             |
...
| \## State Preservation                                                     |
|                                                                            |
| \- Session State: \`state/session\_\[TIMESTAMP\].json\`                    |
|                                                                            |
...
| \-\--                                                                      |
|                                                                            |
| \*\*Next Session Should Start With:\*\* \[Specific first command or        |
| check\]                                                                    |
+============================================================================+
...
|                                                                       |
| State: state/session\_\[TIMESTAMP\].json\"                            |
|                                                                       |
...
|                                                                       |
| \*\*Filename:\*\* \`WEEKLY_SUMMARY\_\[YYYY\]-W\[WW\].md\`             |
|                                                                       |
| \### Tasks:                                                           |
|                                                                       |
| 1\. \*\*Aggregate Progress Reports\*\*                                |
|                                                                       |
| \- Combine all \`PROGRESS\_\*.md\` from this week                     |
|                                                                       |
...
|                                                                       |
| \- Update \`docs/decisions/\` with any informal decisions that should |
| be ADRs                                                               |
|                                                                       |
...
**Trigger:** Complex implementation requiring multi-step autonomous
work.

This is the \"agentic\" pattern: an orchestrated loop with role
separation.
...
| │ ┌──────────────┐ │                                                    |
|                                                                         |
| │ │ PLANNER │ ◄─── Requirements, Tickets, Specs │                       |
|                                                                         |
| │ │ AGENT │ │                                                           |
|                                                                         |
| │ └──────┬───────┘ │                                                    |
|                                                                         |
| │ │ Outputs: Plan, Test Plan, Acceptance Criteria │                     |
|                                                                         |
| │ ▼ │                                                                   |
|                                                                         |
| │ ┌──────────────┐ │                                                    |
|                                                                         |
| │ │ BUILDER │ ◄─── Plan + Codebase + Test Framework │                   |
|                                                                         |
| │ │ AGENT │ │                                                           |
|                                                                         |
| │ └──────┬───────┘ │                                                    |
...
| │ ┌──────────────┐ │                                                    |
|                                                                         |
| │ │ ORCHESTRATOR │ ◄─── Runs: pytest, ruff, mypy, etc. │                |
|                                                                         |
| │ │ AGENT │ │                                                           |
|                                                                         |
| │ └──────┬───────┘ │                                                    |
|                                                                         |
| │ │ Outputs: Tool reports (JSON/MD) │                                   |
|                                                                         |
| │ ▼ │                                                                   |
|                                                                         |
| │ ┌──────────────┐ │                                                    |
|                                                                         |
| │ │ REVIEWER │ ◄─── Spec + Diff + Tool Output (NO explanations) │       |
|                                                                         |
| │ │ AGENT │ │                                                           |
|                                                                         |
| │ └──────┬───────┘ │                                                    |
...
| │ │ │                                                                   |
|                                                                         |
| │ └─── REJECT ────► Back to Builder with specific changes │             |
|                                                                         |
| │ │                                                                     |
|                                                                         |
| └─────────────────────────────────────────────────────────────────────┘ |
...
pytest -v \--tb=long 2\>&1 \| tee evidence/test\_\$(date
+%Y%m%d\_%H%M%S).txt

echo \"Exit Code: \$?\" \>\> evidence/test\_\$(date +%Y%m%d\_%H%M%S).txt

# Run linter

ruff check . 2\>&1 \| tee evidence/lint\_\$(date +%Y%m%d\_%H%M%S).txt

echo \"Exit Code: \$?\" \>\> evidence/lint\_\$(date +%Y%m%d\_%H%M%S).txt

# Run type checker

mypy . 2\>&1 \| tee evidence/types\_\$(date +%Y%m%d\_%H%M%S).txt

echo \"Exit Code: \$?\" \>\> evidence/types\_\$(date
+%Y%m%d\_%H%M%S).txt

# Run coverage

pytest \--cov=. \--cov-report=term-missing 2\>&1 \| tee
evidence/coverage\_\$(date +%Y%m%d\_%H%M%S).txt

# Generate diff

git diff \> evidence/diff\_\$(date +%Y%m%d\_%H%M%S).txt
...
| \|\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\--\| |
|                                                                                                    |
| \| pytest \| \[0/1\] \| \[N failures\] \| \`evidence/test\_\*.txt\` \|                             |
|                                                                                                    |
| \| ruff \| \[0/1\] \| \[N errors\] \| \`evidence/lint\_\*.txt\` \|                                 |
|                                                                                                    |
| \| mypy \| \[0/1\] \| \[N errors\] \| \`evidence/types\_\*.txt\` \|                                |
|                                                                                                    |
| \| coverage \| N/A \| \[X%\] \| \`evidence/coverage\_\*.txt\` \|                                   |
|                                                                                                    |
| \### Pass/Fail Gate                                                                                |
|                                                                                                    |
...
| \*\*Session ID:\*\* \[GENERATE_UNIQUE_ID\]                            |
|                                                                       |
| ⚠️ CRITICAL: You have NOT seen the Builder\'s explanation.            |
|                                                                       |
...
| \*\*Your Task:\*\*                                                    |
|                                                                       |
| Perform adversarial review using the full protocol in §8.1.           |
|                                                                       |
| \*\*Output Required:\*\*                                              |
|                                                                       |
| Full REVIEW\_\[timestamp\].md per §8.1 template.                      |
|                                                                       |
| \*\*Verdict Options:\*\*                                              |
|                                                                       |
| \- APPROVE: All checks pass, risk score ≤ 2                           |
|                                                                       |
...
See §6.2 Task 3 for the complete handoff document template.

**Quick Handoff Checklist:**

> ☐ Progress report generated
>
> ☐ Session state serialized to JSON
>
...
>
> ☐ Handoff tagged for reference

# Part III: Quality Control (Critical)

## ⚠️ READ THIS FIRST

This section addresses the core problem: **AI models summarizing rather
than critically auditing.**

**Why Models Parrot Instead of Audit:**

> **1.** LLMs are trained to be helpful and agreeable
>
> **2.** When Model B reads Model A\'s explanation, it anchors on that
> reasoning
>
...
> **1. Role Separation:** Builder ≠ Reviewer
>
> **2. Blind Reviews:** Reviewer never sees Builder\'s explanations
>
> **3. Adversarial Prompts:** Explicitly task the AI with finding
> problems
>
> **4. Tool Verification:** Claims must be proven with actual command
> output
>
...
|                                                                                                                |
| You are \*\*CriticalArchitect-Alpha\*\*, a senior code auditor with a reputation for being harsh, pedantic,    |
| and strictly standards-obsessed.                                                                               |
|                                                                                                                |
| \### Your Mandate                                                                                              |
|                                                                                                                |
...
|                                                                                                                |
| 4\. If the code is perfect (it isn\'t), output \"NO DEFECTS FOUND\"---but if you miss a bug, you fail.         |
|                                                                                                                |
...
| \|\-\--\|\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\--\| |
|                                                                                                                |
| \| 1 \| \`file.py:42\` \| CRITICAL \| Security \| SQL injection via string concat \| \`query = f\"SELECT \*    |
| FROM {user_input}\"\` \|                                                                                       |
|                                                                                                                |
...
| Choose exactly ONE:                                                                                            |
|                                                                                                                |
| \- \*\*APPROVE:\*\* Risk ≤ 2, no blocking issues. Ready for merge.                                             |
|                                                                                                                |
| \- \*\*REQUEST_CHANGES:\*\* Risk 3-5, specific changes required. List them.                                    |
|                                                                                                                |
| \- \*\*BLOCK:\*\* Risk ≥ 6, critical issues. Cannot proceed until resolved.                                    |
|                                                                                                                |
...
|                                                                       |
| \*\*Your job:\*\* Independently verify whether this code change       |
| satisfies the SPEC and TEST RESULTS.                                  |
|                                                                       |
| \*\*Critical Rule:\*\* Treat all existing code as potentially buggy.  |
| Treat all outputs from other models as UNTRUSTED.                     |
|                                                                       |
| \### You Have Access To:                                              |
|                                                                       |
...
|                                                                       |
| If Risk ≤ 2, explain what you checked and why you\'re confident.      |
|                                                                       |
| \### Constraints:                                                     |
|                                                                       |
...
|                                                                       |
| \- You MUST identify at least 3 concerns OR explicitly argue why      |
| fewer exist                                                           |
+=======================================================================+
...
pytest -v 2\>&1 \| tee evidence/bugfix_XXX\_\$(date +%Y%m%d\_%H%M%S).txt
...
|                                                                       |
| 1\. Describe what you THINK this code does based on function names    |
| only                                                                  |
|                                                                       |
...
|                                                                       |
| 4\. NOW look at implementation - where do expectations differ from    |
| reality?                                                              |
|                                                                       |
| \### Verdict                                                          |
|                                                                       |
...
|                                                                       |
| IMPORTANT: \"PASS\" requires EVIDENCE, not just absence of found      |
| problems.                                                             |
+=======================================================================+
...
|                                                                       |
| Review this code as if submitted by a junior developer who often      |
| misses:                                                               |
|                                                                       |
| \- Edge cases                                                         |
|                                                                       |
...
|                                                                       |
| 1\. \[Issue\] - \[What junior likely missed\] - \[Why it matters\] -  |
| \[How to fix\]                                                        |
+=======================================================================+
...
**The Problem:** When Reviewer sees Builder\'s explanation, they anchor
on that reasoning.
...
├── SPEC.md \# Original requirement (from ticket)

├── diff.txt \# git diff output

├── test_output.txt \# pytest output

├── lint_output.txt \# linter output

├── types_output.txt \# type checker output
...
|                                                                       |
| Use §8.1 ACR Prompt with the review package.                          |
|                                                                       |
| \### Step 5: Document Independently                                   |
|                                                                       |
| Reviewer creates REVIEW\_\*.md with their own analysis.               |
+=======================================================================+

  -----------------------------------------------------------------------
  └── FILES.md \# List of files to review (no explanations)
  -----------------------------------------------------------------------
...
### 11.1 Evidence Requirements by Claim Type
  ...
  -----------------------------------------------------------------------
  **Claim**               **Required Evidence**   **Invalid Evidence**
  ----------------------- ----------------------- -----------------------
  \"Tests pass\"          Full pytest output with \"I ran the tests\"
                          timestamps              

  \"Build succeeds\"      Full build log +        \"It compiled\"
                          artifact hash           

  \"No lint errors\"      Full linter output      \"Lint is clean\"

  \"No type errors\"      Full mypy/pyright       \"Types check out\"
                          output                  

  \"Coverage is X%\"      Coverage report with    \"Coverage is good\"
                          breakdown               

  \"No regressions\"      Before/after comparison \"Everything still
                                                  works\"

  \"Performance OK\"      Benchmark results       \"It\'s fast enough\"
  -----------------------------------------------------------------------
...
|                                                                       |
| OUTPUT=\"evidence/test\_\${TIMESTAMP}.txt\"                           |
|                                                                       |
| mkdir -p evidence                                                     |
|                                                                       |
| {                                                                     |
...
| TIMESTAMP=\$(date +%Y%m%d\_%H%M%S)                                    |
|                                                                       |
| OUTPUT=\"evidence/lint\_\${TIMESTAMP}.txt\"                           |
|                                                                       |
| mkdir -p evidence                                                     |
|                                                                       |
| {                                                                     |
...
| TIMESTAMP=\$(date +%Y%m%d\_%H%M%S)                                    |
|                                                                       |
| OUTPUT=\"evidence/build\_\${TIMESTAMP}.txt\"                          |
|                                                                       |
| mkdir -p evidence                                                     |
|                                                                       |
| {                                                                     |
...
| echo \"=== BUILD OUTPUT ===\"                                         |
|                                                                       |
| make build 2\>&1 \|\| npm run build 2\>&1 \|\| python setup.py build  |
| 2\>&1                                                                 |
|                                                                       |
| echo \"\"                                                             |
|                                                                       |
...
| \|\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\--\| |
|                                                                                                                                                 |
| \| 1 \| \"All tests pass\" \| \`pytest -v\` \| 3 failures \| ❌ NO \|                                                                           |
|                                                                                                                                                 |
| \| 2 \| \"On branch feature-x\" \| \`git branch\` \| main \| ❌ NO \|                                                                           |
|                                                                                                                                                 |
| \| 3 \| \"No lint errors\" \| \`ruff check .\` \| 0 errors \| ✅ YES \|                                                                         |
|                                                                                                                                                 |
| \| 4 \| \"Coverage \> 80%\" \| \`pytest \--cov\` \| 72% \| ❌ NO \|                                                                             |
|                                                                                                                                                 |
| \## Unverified Claims                                                                                                                           |
|                                                                                                                                                 |
...
|                                                                       |
| \- Evidence: \`evidence/test\_\[timestamp\].txt\`                     |
|                                                                       |
| \- Result: \[PASS/FAIL\]                                              |
|                                                                       |
| \- \[ \] \*\*Lint:\*\* \`make lint\` exits with code 0                |
|                                                                       |
| \- Evidence: \`evidence/lint\_\[timestamp\].txt\`                     |
|                                                                       |
| \- Result: \[PASS/FAIL\]                                              |
|                                                                       |
| \- \[ \] \*\*Types:\*\* \`make typecheck\` exits with code 0          |
|                                                                       |
| \- Evidence: \`evidence/types\_\[timestamp\].txt\`                    |
|                                                                       |
| \- Result: \[PASS/FAIL\]                                              |
|                                                                       |
| \- \[ \] \*\*Build:\*\* \`make build\` exits with code 0              |
|                                                                       |
| \- Evidence: \`evidence/build\_\[timestamp\].txt\`                    |
|                                                                       |
| \- Result: \[PASS/FAIL\]                                              |
|                                                                       |
| \### Coverage Gate                                                    |
...
|                                                                       |
| \- Evidence: \`evidence/diff\_\[timestamp\].txt\`                     |
|                                                                       |
| \### Gate Status                                                      |
|                                                                       |
| \- \[ \] ALL GATES PASS → Proceed with handoff                        |
|                                                                       |
| \- \[ \] ANY GATE FAILS → Fix before handoff                          |
|                                                                       |
| \### Signature                                                        |
+=======================================================================+
...
+-----------------------------------------------------------------------+
| \[Source A\] ──► \[Transform 1\] ──► \[Transform 2\] ──►              |
| \[Destination\]                                                       |
|                                                                       |
| \[Source B\] ──────────────────────┘                                  |
+=======================================================================+
...
### Steps
  ...
  **\#**         **Step**       **Input**      **Output**     **Validation**
  -------------- -------------- -------------- -------------- ----------------
  1              Extract from A Raw            DataFrame      Schema check

  2              Extract from B Raw            DataFrame      Schema check

  3              Join A + B     2 DataFrames   1 DataFrame    Row count

  4              Transform      DataFrame      DataFrame      Business rules

  5              Load           DataFrame      Database       Integrity check
  ----------------------------------------------------------------------------
...
+-----------------------------------------------------------------------+
| \*\*⏸️ STOP: Wait for approval on the plan.\*\*                       |
|                                                                       |
| \### Phase 3: DECIDE & ACT                                            |
|                                                                       |
...
| \### Constraints                                                      |
|                                                                       |
| \- Do NOT output code that assumes external variables exist (define   |
| them)                                                                 |
|                                                                       |
...
| pass                                                                  |
|                                                                       |
| def assert_schema(df: pd.DataFrame, expected: Dict\[str, type\]) -\>  |
| None:                                                                 |
|                                                                       |
...
|                                                                       |
| \*\*Rationale:\*\* \[Detailed reasoning referencing decision          |
| drivers\]                                                             |
|                                                                       |
| \### Consequences                                                     |
|                                                                       |
...
| \|\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\--\| |
|                                                                       |
| \| Size bound \| Output ≤ input \| \`len(compress(x)) \<= len(x)\` \| |
|                                                                       |
| \| Idempotency \| \`f(f(x)) == f(x)\` \| \`normalize(normalize(x)) == |
| normalize(x)\` \|                                                     |
|                                                                       |
...
| TIMESTAMP=\$(date +%Y%m%d\_%H%M%S)                                    |
|                                                                       |
| EVIDENCE_DIR=\"evidence/test_run\_\${TIMESTAMP}\"                     |
|                                                                       |
| mkdir -p \"\$EVIDENCE_DIR\"                                           |
|                                                                       |
| echo \"=== SparkData Test Evidence Collection ===\" \| tee            |
| \"\$EVIDENCE_DIR/summary.txt\"                                        |
|                                                                       |
| echo \"Timestamp: \$(date -Iseconds)\" \| tee -a                      |
| \"\$EVIDENCE_DIR/summary.txt\"                                        |
|                                                                       |
| echo \"Git SHA: \$(git rev-parse HEAD)\" \| tee -a                    |
| \"\$EVIDENCE_DIR/summary.txt\"                                        |
|                                                                       |
...
|                                                                       |
| pytest tests/unit -v \--tb=short 2\>&1 \| tee                         |
| \"\$EVIDENCE_DIR/unit_tests.txt\"                                     |
|                                                                       |
| echo \"Exit Code: \$?\" \| tee -a \"\$EVIDENCE_DIR/unit_tests.txt\"   |
|                                                                       |
| \# Integration tests                                                  |
|                                                                       |
| echo \"=== Integration Tests ===\" \| tee -a                          |
| \"\$EVIDENCE_DIR/summary.txt\"                                        |
|                                                                       |
| pytest tests/integration -v \--tb=short 2\>&1 \| tee                  |
| \"\$EVIDENCE_DIR/integration_tests.txt\"                              |
|                                                                       |
| echo \"Exit Code: \$?\" \| tee -a                                     |
| \"\$EVIDENCE_DIR/integration_tests.txt\"                              |
|                                                                       |
| \# Coverage report                                                    |
|                                                                       |
...
| \--cov-report=html:\"\$EVIDENCE_DIR/htmlcov\" 2\>&1 \| tee            |
| \"\$EVIDENCE_DIR/coverage.txt\"                                       |
|                                                                       |
| \# Generate coverage badge                                            |
|                                                                       |
| coverage-badge -o \"\$EVIDENCE_DIR/coverage.svg\" 2\>/dev/null \|\|   |
...
|                                                                              |
| 3\. Why did \[CAUSE 2\] occur? → \[CAUSE 3\]                                 |
|                                                                              |
| 4\. Why did \[CAUSE 3\] occur? → \[CAUSE 4\]                                 |
|                                                                              |
...
grep -r \"\^import\\\|\^from\" \--include=\"\*.py\" \| sort \| uniq -c
\| sort -rn
...
| \|\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\-\-\-\--\|\-\-\-\-\-\-\--\|       |
|                                                                       |
| \| Latency \| \`request_duration_seconds\` \| method, endpoint,       |
| status \|                                                             |
|                                                                       |
...
| \## Forbidden Behaviors                                               |
|                                                                       |
| \- Do NOT start responses with \"Here is the code\" or \"I have       |
| analyzed\...\"                                                        |
|                                                                       |
...
| clean:                                                                |
|                                                                       |
| rm -rf \_\_pycache\_\_ .pytest_cache .mypy_cache htmlcov .coverage    |
|                                                                       |
...
| mkdir -p evidence                                                     |
|                                                                       |
| make test 2\>&1 \| tee evidence/test\_\$\$(date +%Y%m%d\_%H%M%S).txt  |
|                                                                       |
| make lint 2\>&1 \| tee evidence/lint\_\$\$(date +%Y%m%d\_%H%M%S).txt  |
|                                                                       |
| make typecheck 2\>&1 \| tee evidence/types\_\$\$(date                 |
| +%Y%m%d\_%H%M%S).txt                                                  |
|                                                                       |
...
Add these to your IDE\'s command palette or keyboard shortcuts:
  ...
  -----------------------------------------------------------------------
  **Command**             **Action**              **Shortcut Suggestion**
  ----------------------- ----------------------- -----------------------
  ai-plan                 Open Planner Agent      Ctrl+Shift+P
                          session                 

  ai-build                Open Builder Agent      Ctrl+Shift+B
                          session                 

  ai-review               Open Reviewer Agent     Ctrl+Shift+R
                          session                 

  ai-test                 Generate tests for      Ctrl+Shift+T
                          selection               

  ai-explain              Explain selected code   Ctrl+Shift+E
  -----------------------------------------------------------------------
...
|                                                                       |
| Find problems. Use adversarial review rubric from SOP §8.1.           |
+=======================================================================+
...
Every data pipeline at SparkData Analytics must satisfy these
requirements:
...
|                                                                       |
| \- \[ \] Input schema defined (\`schemas/input\_\[pipeline\].json\`)  |
|                                                                       |
| \- \[ \] Output schema defined                                        |
| (\`schemas/output\_\[pipeline\].json\`)                               |
|                                                                       |
| \- \[ \] Null handling specified for each field                       |
|                                                                       |
| \- \[ \] Valid value ranges documented                                |
...
|                                                                       |
| if self.value is not None and (self.value \< 0 or self.value \>       |
| 1000000):                                                             |
|                                                                       |
...
|                                                                       |
| def \_\_init\_\_(self, pipeline_name: str):                           |
|                                                                       |
...
| passed=passed,                                                        |
|                                                                       |
| message=f\"Row count {actual} {\'within\' if passed else \'outside\'} |
...
| if not passed:                                                        |
|                                                                       |
| logger.warning(f\"\[{self.pipeline_name}\] Row count check failed:    |
| {result.message}\")                                                   |
|                                                                       |
| return result                                                         |
|                                                                       |
...
|                                                                       |
| message=f\"Null check {\'passed\' if not has_nulls else               |
| \'failed\'}\",                                                        |
|                                                                       |
...
| if has_nulls:                                                         |
|                                                                       |
| logger.warning(f\"\[{self.pipeline_name}\] Null check failed:         |
| {null_counts}\")                                                      |
|                                                                       |
| return result                                                         |
|                                                                       |
...
| if dup_count \> 0:                                                    |
|                                                                       |
| logger.warning(f\"\[{self.pipeline_name}\] Duplicates found on        |
| {columns}\")                                                          |
|                                                                       |
| return result                                                         |
|                                                                       |
...
|                                                                       |
| details={\"column\": column, \"orphan_count\": len(orphans),          |
...
| if orphans:                                                           |
|                                                                       |
| logger.warning(f\"\[{self.pipeline_name}\] Orphan values in {column}: |
| {list(orphans)\[:5\]}\")                                              |
|                                                                       |
| return result                                                         |
|                                                                       |
...
|                                                                       |
| out_of_range = df\[(df\[column\] \< min_val) \| (df\[column\] \>      |
| max_val)\]                                                            |
|                                                                       |
...
| \### Patterns That Work                                               |
|                                                                       |
| ✅ \"You are \[ROLE\]. Your task is \[SPECIFIC\].\"                   |
|                                                                       |
| ✅ \"Output format: \[STRUCTURE\]\"                                   |
|                                                                       |
| ✅ \"Constraints: Do NOT \[THING\]\"                                  |
|                                                                       |
...
|                                                                       |
| ║ ├─ Load: Session Initialization (§5.1 or §5.3) ║                    |
|                                                                       |
| ║ └─ Verify: Previous claims match reality ║                          |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
...
| ║ ├─ Run: make check ║                                                |
|                                                                       |
| ║ └─ Leave in \"pending review\" state ║                              |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ 🔴 QUALITY CONTROL (Reviewer Mode - SEPARATE SESSION) ║             |
|                                                                       |
| ║ ├─ Open FRESH session (no prior context) ║                          |
|                                                                       |
| ║ ├─ Load: Blind Review Init (§5.3) ║                                 |
|                                                                       |
| ║ ├─ Run: Adversarial Code Review (§8.1) ║                            |
|                                                                       |
| ║ └─ Output: REVIEW\_\*.md with verdict ║                             |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ 📝 END SESSION ║                                                    |
...
| ║ ├─ Run: make evidence ║                                             |
|                                                                       |
| ║ ├─ Generate: Progress Report (§6.1) ║                               |
|                                                                       |
| ║ ├─ If handoff: Complete Handoff (§6.2) ║                            |
|                                                                       |
| ║ └─ Commit with comprehensive message ║                              |
|                                                                       |
| ║ ║                                                                   |
...
|                                                                       |
| ║ 3. \[ \] Create #incident-\[timestamp\] channel ║                   |
|                                                                       |
| ║ 4. \[ \] Notify on-call engineer ║                                  |
|                                                                       |
| ║ 5. \[ \] Update status page ║                                       |
|                                                                       |
| ║ 6. \[ \] Implement quick mitigation ║                               |
|                                                                       |
...
|                                                                       |
| ║ - Scale: kubectl scale deployment/app \--replicas=10 ║              |
|                                                                       |
| ║ - Circuit break: Enable feature flag CIRCUIT_BREAK=true ║           |
|                                                                       |
| ║ - Redirect: Update load balancer to backup ║                        |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ ESCALATION: ║                                                       |
|                                                                       |
| ║ - P0: Immediate page + status page + stakeholders ║                 |
|                                                                       |
| ║ - P1: 30min response + team channel ║                               |
|                                                                       |
| ║ - P2: 4hr response + email ║                                        |
|                                                                       |
| ║ - P3: 24hr response + ticket ║                                      |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ╚═══════════════════════════════════════════════════════════════════╝ |
...
| ║ - \[ \] Fresh session (no prior context) ║                          |
|                                                                       |
| ║ - \[ \] NO builder explanations loaded ║                            |
|                                                                       |
| ║ - \[ \] Only have: spec + code + test output ║                      |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ 📋 REVIEW CHECKLIST: ║                                              |
...
| ║ 🎯 RISK SCORE: ║                                                    |
|                                                                       |
| ║ 0-2: APPROVE (low risk) ║                                           |
|                                                                       |
| ║ 3-5: REQUEST_CHANGES (moderate) ║                                   |
|                                                                       |
| ║ 6-8: BLOCK (high risk) ║                                            |
|                                                                       |
| ║ 9-10: CRITICAL (do not deploy) ║                                    |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ 📝 REQUIRED OUTPUT: ║                                               |
|                                                                       |
| ║ - Defect table with severity ║                                      |
|                                                                       |
...
|                                                                       |
| ║ - \"The author did\...\" (you don\'t know the author) ║             |
|                                                                       |
| ║ - \"As mentioned before\...\" (no prior context) ║                  |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ╚═══════════════════════════════════════════════════════════════════╝ |
...
| ║ Progress Reports: ║                                                 |
|                                                                       |
| ║ PROGRESS_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION_ID\].md ║        |
|                                                                       |
| ║ Example: PROGRESS_2025-11-30_14-30-00_claude-opus_abc123.md ║       |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Handoff Documents: ║                                                |
|                                                                       |
| ║                                                                     |
| docs/handoffs/HANDOFF_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION\].md  |
| ║                                                                     |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Review Documents: ║                                                 |
|                                                                       |
| ║ REVIEW_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION_ID\].md ║          |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Discrepancy Reports: ║                                              |
...
| ║ Decision Records: ║                                                 |
|                                                                       |
| ║ docs/decisions/ADR_YYYY-MM-DD\_\[NUM\]\_\[title-slug\].md ║         |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Session States: ║                                                   |
|                                                                       |
| ║ state/session_YYYY-MM-DD_HH-MM-SS\_\[MODEL\]\_\[SESSION\].json ║    |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Evidence Files: ║                                                   |
|                                                                       |
| ║ evidence/\[type\]\_YYYYMMDD_HHMMSS.txt ║                            |
|                                                                       |
| ║ Types: test, lint, types, build, coverage ║                         |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ╚═══════════════════════════════════════════════════════════════════╝ |
...
| ║ ║                                                                   |
|                                                                       |
| ║ Document: SparkData Analytics AI-Assisted Development SOP ║         |
|                                                                       |
| ║ Version: 5.2.0 (Gold Standard Compliance Edition) ║                 |
|                                                                       |
...
|                                                                       |
| ║ ✓ Eliminate AI sycophancy in code review ║                          |
|                                                                       |
| ║ ✓ Enable multi-agent agentic workflows ║                            |
|                                                                       |
| ║ ✓ Enforce proof-of-work quality gates ║                             |
|                                                                       |
| ║ ✓ Maintain context across long-running projects ║                   |
|                                                                       |
| ║ ✓ Support SparkData\'s data engineering focus ║                     |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Core Improvements Over Previous Versions: ║                         |
|                                                                       |
| ║ • Added Fifth Pillar: Adversarial Independence ║                    |
|                                                                       |
| ║ • Added Role Separation (Builder/Reviewer/etc.) ║                   |
|                                                                       |
| ║ • Added Blind Audit Protocols ║                                     |
|                                                                       |
| ║ • Added Proof of Work Requirements ║                                |
|                                                                       |
| ║ • Added Agentic Coding Loop (Workflow 4) ║                          |
|                                                                       |
| ║ • Added Pipeline-Specific Standards ║                               |
|                                                                       |
| ║ • Added IDE Integration (.cursorrules) ║                            |
|                                                                       |
| ║ ║                                                                   |
|                                                                       |
| ║ Approved By: SparkData Engineering ║                                |
|                                                                       |
| ║ Next Review: Q1 2026 ║                                              |
|                                                                       |
| ║ ║                                                                   |
...
This example demonstrates the lightweight T1 workflow for a typical
minor change.

## E.1 Scenario

**Change:** Fix a small front-end data-binding bug in the user
dashboard.
...
|                                                                       |
| \*\*Justification:\*\* UI change affecting non-core feature display.  |
| No data model changes, no auth impact, no pipeline changes.           |
|                                                                       |
...
- \<MetricsCard value={metrics.count} /\>
...
| \|\-\-\-\-\-\--\|\-\-\-\-\-\-\--\|\-\-\-\-\-\-\-\-\--\|               |
|                                                                       |
| \| Correctness vs SPEC \| Pass \| Null-safe access matches bug        |
| description \|                                                        |
|                                                                       |
...
|                                                                       |
| \| Security concerns \| Pass \| No security implications for UI null  |
| check \|                                                              |
|                                                                       |
| \| Performance \| Pass \| Optional chaining is O(1) \|                |
|                                                                       |
| \| Patterns \| Pass \| Follows existing null-safe patterns in         |
| codebase \|                                                           |
|                                                                       |
...
| \*\*Score: 1/10\*\*                                                   |
|                                                                       |
| Low risk change. Single-line null-safe fix with appropriate test      |
| coverage. The optional chaining pattern is consistent with the rest   |
| of the codebase. Default value of 0 is reasonable during loading      |
| state.                                                                |
|                                                                       |
| \### Required Changes                                                 |
|                                                                       |
| None required. Risk ≤ 2.                                              |
|                                                                       |
| Verified:                                                             |
|                                                                       |
...
| git checkout main && git pull                                         |
|                                                                       |
| git merge \--no-ff feature/dashboard-null-fix -m \"fix: null-safe     |
| metrics access in dashboard                                           |
|                                                                       |
| Reviewed-by: gpt-4o                                                   |
|                                                                       |
...
This script guides developers through the tier-appropriate workflow,
checking that required evidence files exist before proceeding.
...
| \"╔═══════════════════════════════════════════════════════════════════╗\" |
|                                                                           |
| echo \"║ SPARKDATA AI ORCHESTRATOR v1.0 ║\"                               |
|                                                                           |
| echo                                                                      |
| \"╚═══════════════════════════════════════════════════════════════════╝\" |
|                                                                           |
...
|                                                                           |
| echo -e \"\${YELLOW}Step 1: What is the Risk Tier for this                |
| change?\${NC}\"                                                           |
|                                                                           |
| echo \" T0 - Low (docs, comments, non-prod scripts)\"                     |
|                                                                           |
| echo \" T1 - Medium (non-core features, UI, minor pipelines)              |
| \[DEFAULT\]\"                                                             |
|                                                                           |
...
| T1)                                                                       |
|                                                                           |
| echo \"1️⃣ Run Builder Mode (#1) in Chat Window A\"                        |
|                                                                           |
| echo \" → Save output to PROGRESS\_\*.md\"                                |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"2️⃣ Run: make evidence\"                                            |
|                                                                           |
| echo \" → Creates test_evidence.txt, lint_evidence.txt,                   |
| types_evidence.txt\"                                                      |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"3️⃣ ⚠️ OPEN NEW CHAT WINDOW B (fresh session!)\"                    |
|                                                                           |
| echo \" → Run Reviewer Mode (#2)\"                                        |
|                                                                           |
| echo \" → Paste: spec + diff + tool results\"                             |
|                                                                           |
| echo \" → Do NOT paste builder\'s explanation!\"                          |
|                                                                           |
| ;;                                                                        |
|                                                                           |
| T2)                                                                       |
...
| echo \"3️⃣ ⚠️ OPEN NEW CHAT WINDOW B (fresh session!)\"                    |
|                                                                           |
| echo \" → Run Verification Mode (#3)\"                                    |
|                                                                           |
| echo \" → Save to reports/VERIFICATION\_\*.md\"                           |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"4️⃣ Run at least 1 Lens (Security #4 OR Performance #5)\"           |
|                                                                           |
| echo \" → Save to reports/PERSPECTIVE\_\*.md\"                            |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"5️⃣ For pipelines: Run Data-Quality Lens (#10)\"                    |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"6️⃣ Create DECISION\_\*.json in logs/ai-decisions/\"                |
|                                                                           |
| ;;                                                                        |
|                                                                           |
| T3)                                                                       |
...
| echo \"\"                                                                 |
|                                                                           |
| echo \"3️⃣ ⚠️ Run ALL 4 Lenses (ideally different model families):\"       |
|                                                                           |
| echo \" → Security-First (#4)\"                                           |
|                                                                           |
| echo \" → Performance-First (#5)\"                                        |
|                                                                           |
| echo \" → Maintainability-First (#6)\"                                    |
|                                                                           |
| echo \" → Resilience-First (#7)\"                                         |
|                                                                           |
| echo \" → For pipelines: Data-Quality-First (#10)\"                       |
|                                                                           |
| echo \" → Save each to reports/PERSPECTIVE\_\*.md\"                       |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"4️⃣ Check agreement: If \>80% overlap, run Devil\'s Advocate (#8)\" |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"5️⃣ Run Differential Comparison (#9) with 2nd model family\"        |
|                                                                           |
| echo \" → Save to reports/COMPARISON\_\*.md\"                             |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"6️⃣ Create DECISION\_\*.json with all models listed\"               |
|                                                                           |
| echo \"\"                                                                 |
|                                                                           |
| echo \"7️⃣ Get senior human approval before merge\"                        |
|                                                                           |
| ;;                                                                        |
|                                                                           |
| esac                                                                      |
...
| echo \"\"                                                                 |
|                                                                           |
| echo -e \"\${YELLOW}Step 3: Checking for existing evidence                |
| files\...\${NC}\"                                                         |
|                                                                           |
| check_file() {                                                            |
|                                                                           |
...
| if \[\[ \"\$TIER\" != \"T0\" \]\]; then                                   |
|                                                                           |
| check_file \"evidence/test\_\*.txt\" 2\>/dev/null \|\| MISSING=1          |
|                                                                           |
| check_file \"evidence/lint\_\*.txt\" 2\>/dev/null \|\| MISSING=1          |
|                                                                           |
| check_file \"evidence/types\_\*.txt\" 2\>/dev/null \|\| MISSING=1         |
|                                                                           |
| fi                                                                        |
|                                                                           |
| if \[\[ \"\$TIER\" == \"T2\" \|\| \"\$TIER\" == \"T3\" \]\]; then         |
|                                                                           |
| ls reports/VERIFICATION\_\*.md &\>/dev/null && echo -e \"                 |
| \${GREEN}✓\${NC} VERIFICATION\_\*.md exists\" \|\| { echo -e \"           |
| \${RED}✗\${NC} VERIFICATION\_\*.md missing\"; MISSING=1; }                |
|                                                                           |
| ls logs/ai-decisions/DECISION\_\*.json &\>/dev/null && echo -e \"         |
| \${GREEN}✓\${NC} DECISION\_\*.json exists\" \|\| { echo -e \"             |
| \${RED}✗\${NC} DECISION\_\*.json missing\"; MISSING=1; }                  |
|                                                                           |
| fi                                                                        |
|                                                                           |
| if \[\[ \"\$TIER\" == \"T3\" \]\]; then                                   |
|                                                                           |
| PERSP_COUNT=\$(ls reports/PERSPECTIVE\_\*.md 2\>/dev/null \| wc -l)       |
|                                                                           |
| if \[ \"\$PERSP_COUNT\" -ge 4 \]; then                                    |
|                                                                           |
| echo -e \" \${GREEN}✓\${NC} \$PERSP_COUNT PERSPECTIVE\_\*.md files        |
| found\"                                                                   |
|                                                                           |
| else                                                                      |
|                                                                           |
| echo -e \" \${RED}✗\${NC} Only \$PERSP_COUNT PERSPECTIVE\_\*.md files     |
| (need 4+)\"                                                               |
|                                                                           |
| MISSING=1                                                                 |
|                                                                           |
...
|                                                                           |
| echo -e \"\${RED}⚠️ Some required evidence is missing. Complete the       |
| workflow above before merging.\${NC}\"                                    |
|                                                                           |
| else                                                                      |
|                                                                           |
| echo -e \"\${GREEN}✓ All required evidence present for \$TIER!\${NC}\"    |
|                                                                           |
| fi                                                                        |
|                                                                           |
| echo \"\"                                                                 |
...
| ║ Document: SparkData Analytics AI-Assisted Development SOP ║                     |
|                                                                                   |
| ║ Version: 5.2.0 (Gold Standard Final Edition) ║                                  |
|                                                                                   |
| ║ Last Updated: November 30, 2025 ║                                               |
|                                                                                   |
| ║ ║                                                                               |
...
| ║ COMPANION DOCUMENTS: ║                                                          |
|                                                                                   |
| ║ • Risk Tier Table v2.1 (SparkData_Risk_Tier_Table_v2.1.md) ║                    |
|                                                                                   |
| ║ • IDE Quick Prompts v2.1 (SparkData_IDE_Quick_Prompts_v2.1.md) ║                |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ EXPLICIT STANDARDS ALIGNMENT: ║                                                 |
|                                                                                   |
| ║ ✓ AICPA Quality Management Standards (SQMS No. 1) ║                             |
|                                                                                   |
| ║ ✓ EU Artificial Intelligence Act (High-Risk Guidance) ║                         |
|                                                                                   |
| ║ ✓ PCAOB AI Risk Management Guidance ║                                           |
|                                                                                   |
| ║ ✓ Agentic AI Industry Patterns (2025) ║                                         |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ FIVE QUICK WINS IMPLEMENTED: ║                                                  |
|                                                                                   |
| ║ 1. ✓ Independent Verification Agent (§1.1.1) ║                                  |
|                                                                                   |
| ║ 2. ✓ Structured Decision Logging (§1.1.2) ║                                     |
|                                                                                   |
| ║ 3. ✓ Perspective Diversity Protocol (§1.1.3) ║                                  |
|                                                                                   |
| ║ 4. ✓ Differential Model Comparison Gates (§1.1.4) ║                             |
|                                                                                   |
| ║ 5. ✓ Automated Quality Feedback Loop (§1.1.5) ║                                 |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ RISK TIERING IMPLEMENTED: ║                                                     |
|                                                                                   |
| ║ ✓ T0-T3 tier definitions with clear criteria ║                                  |
|                                                                                   |
| ║ ✓ Escalating controls by tier ║                                                 |
|                                                                                   |
| ║ ✓ Evidence requirements by tier ║                                               |
|                                                                                   |
| ║ ✓ Human oversight requirements by tier ║                                        |
|                                                                                   |
| ║ ✓ CI enforcement hooks defined ║                                                |
|                                                                                   |
| ║ ✓ Tier dispute resolution process ║                                             |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ IDE QUICK PROMPTS IMPLEMENTED: ║                                                |
|                                                                                   |
| ║ ✓ 10 standardized prompts for all roles (including Data-Quality Lens) ║         |
|                                                                                   |
| ║ ✓ Metadata blocks for audit trail ║                                             |
|                                                                                   |
| ║ ✓ Falsification-oriented verification ║                                         |
|                                                                                   |
| ║ ✓ Multi-model diversity requirements ║                                          |
|                                                                                   |
| ║ ✓ Agreement measurement triggers ║                                              |
|                                                                                   |
| ║ ✓ Approved model families for T3 ║                                              |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ KEY ENHANCEMENTS IN v5.2: ║                                                     |
|                                                                                   |
| ║ • Fixed version metadata consistency ║                                          |
|                                                                                   |
| ║ • Explicit fresh chat separation rule (§3.2.1) ║                                |
|                                                                                   |
| ║ • Inline AI (autocomplete) policy (§3.2.2) ║                                    |
|                                                                                   |
| ║ • Tier dispute resolution process ║                                             |
|                                                                                   |
| ║ • Data-Quality-First Lens for pipelines ║                                       |
|                                                                                   |
| ║ • T1 worked example appendix ║                                                  |
|                                                                                   |
| ║ • AI orchestrator script ║                                                      |
|                                                                                   |
| ║ • Approved model families table ║                                               |
|                                                                                   |
| ║ • Future automation roadmap notes ║                                             |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ Approved By: SparkData Engineering ║                                            |
...
## B.2 Risk Tier Definitions
  ...
  **Tier**          **Name**          **Examples**      **Default?**
  ----------------- ----------------- ----------------- -----------------
  **T0**            Low               Docs, comments,   No
                                      non-prod scripts  

  **T1**            Medium            Non-core          **YES**
                                      features, UI,     
                                      minor pipelines   

  **T2**            High              Core logic, data  No
                                      models, auth, key 
                                      pipelines         

  **T3**            Critical          Security, PII,    No
                                      billing,          
                                      regulatory,       
                                      MDRS/RAI          
  -----------------------------------------------------------------------
...
## B.3 Required Controls Summary
  ...
  ---------------------------------------------------------------------------
  **Tier**          **AI Agents**     **Evidence**          **Human
                                                            Oversight**
  ----------------- ----------------- --------------------- -----------------
  **T0**            Builder           None                  None
                    (optional)                              

  **T1**            Builder +         test + lint + types   Human merges
                    Adversarial                             
                    Reviewer (blind)                        

  **T2**            Planner +         T1 +                  Lead approval
                    Builder +         DECISION\_\*.json     
                    Verification                            
                    Agent + 1 Lens                          

  **T3**            All T2 + 4-Lens + All +                 Senior +
                    Devil\'s          PERSPECTIVE\_*.md +   Compliance
                    Advocate +        COMPARISON\_*.md      
                    Differential Gate                       
                    (≥2 models)                             
  ---------------------------------------------------------------------------
...
>
> **5. ⚠️ ESCALATION:** Time pressure cannot lower tier - escalate to
> Lead/CTO
...
- DECISION\_\*.json exists

- VERIFICATION\_\*.md exists (T2+)

- 4x PERSPECTIVE\_\*.md exists (T3)

- Tier in decision log matches PR label
...
## C.1 Available Prompts
  ...
  **\#**            **Prompt**              **Tier**          **Purpose**
  ----------------- ----------------------- ----------------- -----------------
  1                 Builder Mode            All               Implement
                                                              changes + tests

  2                 Reviewer Mode           T1+               Adversarial
                                                              review (blind)

  3                 Verification Mode       T2/T3             Independent gate

  4                 Security-First Lens     T2/T3             Security
                                                              perspective

  5                 Performance-First Lens  T2/T3             Performance
                                                              perspective

  6                 Maintainability-First   T2/T3             Maintainability
                    Lens                                      perspective

  7                 Resilience-First Lens   T2/T3             Resilience
                                                              perspective

  8                 Devil\'s Advocate       T3                Challenge high
                                                              agreement

  9                 Differential Comparison T3                Compare model
                                                              outputs
  -----------------------------------------------------------------------------

## C.2 Critical Rules

- 🔴 ALWAYS start Reviewer/Verification in FRESH CHAT

- 🔴 NEVER show Builder\'s explanation to Reviewer

- 🔴 ALWAYS paste actual TOOL RESULTS

- 🔴 ALWAYS include METADATA block

- 🔴 T3: Use DIFFERENT model families for each lens

- 🔴 Agreement \>80% = Trigger Devil\'s Advocate
...
| ║ IDE QUICK PROMPTS IMPLEMENTED: ║                                                |
|                                                                                   |
| ║ ✓ 9 standardized prompts for all roles ║                                        |
|                                                                                   |
| ║ ✓ Metadata blocks for audit trail ║                                             |
|                                                                                   |
| ║ ✓ Falsification-oriented verification ║                                         |
...
| ║ KEY ENHANCEMENTS IN v5.2: ║                                                     |
|                                                                                   |
| ║ • Explicit independence requirements in control matrix ║                        |
|                                                                                   |
| ║ • Evidence file schemas defined ║                                               |
|                                                                                   |
| ║ • Agreement measurement methods specified ║                                     |
|                                                                                   |
| ║ • Escalation rule for time pressure ║                                           |
|                                                                                   |
| ║ • Data pipeline special rules ║                                                 |
|                                                                                   |
| ║ • CI enforcement hooks ║                                                        |
|                                                                                   |
| ║ • Differential Comparison prompt added ║                                        |
|                                                                                   |
| ║ • Metadata blocks in all prompts ║                                              |
|                                                                                   |
| ║ • Test requirement in reviewer output ║                                         |
|                                                                                   |
| ║ ║                                                                               |
|                                                                                   |
| ║ Approved By: SparkData Engineering ║                                            |
